...
import { SalonMessageComponent } from './ecrans/salon-message/salon-message.component';
import { ListeUtilisateursComponent } from './ecrans/liste-utilisateurs/liste-utilisateurs.component';
...
export const routes: Routes = [
  ...
  { 
    path: 'message/:salonId', 
    component: SalonMessageComponent,
    canActivate: [userGuard],
  },
  { 
    path: ':serveurId/utilisateurs', 
